...
#New aspect. It returns the Boolean whether or not the point you pass is outside the canvas
...
#if it does hit a wall, call this
...
#Quick explanation: this is the range
canvas = Canvas(10, 30)
scribe = TerminalScribe(canvas)
#The degrees for direction
scribe.setDegrees(30)
#The steps (how long it goes)
scribe.forward(700)
