...
class TerminalScribe:
    ...
    def forward(self):
        # Increase the step size for larger movements
        step = 1
        pos = [self.pos[0] + step * self.direction[0], self.pos[1] + step * self.direction[1]]
...
scribes = [
    {'degrees': 0, 'position': [15, 15], 'instructions': [
        {'function': 'forward', 'duration': 1},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 1},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 2},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 2},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 3},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 3},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 4},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 4},
        {'function': 'right', 'duration': 1},
        ...
        {'function': 'forward', 'duration': 5},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 6},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 6},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 7},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 7},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 8},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 8},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 9},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 9},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 10},
    ]},
    {'degrees': 90, 'position': [15, 15], 'instructions': [
        {'function': 'forward', 'duration': 1},
        {'function': 'right', 'duration': 1},
        {'function': 'forward', 'duration': 1},
        {'function': 'right', 'duration': 1},
